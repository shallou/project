 ...
 <body>
  <div class="mws-panel grid_8"> 
   ...
   <div class="mws-panel-body no-padding"> 
    <form class="mws-form" action="/adminarticles/{{$info->id}}" method="post" enctype="multipart/form-data"> 
     <div class="mws-form-inline"> 
      ...
      <div class="mws-form-row"> 
       ...
       <div class="mws-form-item"> 
        <input type="text" class="large" name="editor" value="{{$info->editor}}"/> 
       </div> 
      </div> 
      ...
      <div class="mws-form-row"> 
       ...
       <div class="mws-form-item"> 
        <img src="{{$info->thumb}}" style="width:100px;height:100px;">
        <input type="file" class="large" name="thumb" value="{{$info->thumb}}"/> 
       </div> 
      </div> 
       <div class="mws-form-row"> 
       ...
       <div class="mws-form-item"> 
        ...
        <!-- <textarea name="descr" value="1111"></textarea> -->
        <!-- <input type="text" name="descr" value="{{$info->descr}}"> -->
       </div> 
      </div> 
