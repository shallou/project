    ...
    <div class="float-bar-wrapper"> 
     ...
     <div class="float-bar-right"> 
      ...
      <div class="price-sum"> 
       ...
       <strong class="price">&yen;<em id="J_Total">0元</em></strong> 
      </div> 
      <div class="">
        {{csrf_field()}} 
       <input type="submit" name="jiesuan" value="结算" style="background-color:green;width:150px;height:100px;color:black" /> 
      </div> 
     </div> 
    </div>  
    <div class="footer"> 
