  ...
  <div id="header"> 
   <div class="header-layout"> 
    <div style="float:left;margin-top:-15px;"> 
     <img src="/static/Homes/theme/icon/logo.png" alt="" style="height:70px" /> 
    </div> 
    <h2 class="logo-title"> 找回密码 </h2> 
    <ul class="header-nav"> 
     <li class="nav-first"><a href="/homeregister/create" target="_blank"> 注册 </a></li> 
     <li><a href="/homelogin/create" target="_blank"> 登录 </a></li> 
    ...
    <div class="center"> 
     <div class="am-cf am-padding"> 
      <div class="am-fl am-cf">
       <strong class="am-text-danger am-text-lg">密保验证修改密码</strong>
      </div> 
     </div> 
     <hr /> 
     <!--进度条--> 
     <div class="m-progress"> 
      <div class="m-progress-list"> 
       <span class="step-1 step" id="span1"> <em class="u-progress-stage-bg"></em> <i class="u-stage-icon-inner">1<em class="bg"></em></i> <p class="stage-name">密保验证</p> </span> 
     ...
     <form class="am-form am-form-horizontal" action="/editmibao/{{$id}}" method="post"> 
      <div class="center div1" style="display:;"> 
       <input type="password" name="password" style="display:block;float:left;width:200px;margin:0px 20px 30px 100px" placeholder="修改密码" /> 
       {{csrf_field()}}
       <input type="submit" value="修改密码验证" class="am-btn am-btn-success" id="huoqu" style="display:block;float:left;width:150px">
      </div> 
