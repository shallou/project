    ...
    <div class="center"> 
     <div class="am-cf am-padding"> 
      <div class="am-fl am-cf">
       <strong class="am-text-danger am-text-lg">密保验证</strong>
      </div> 
     </div> 
     <hr /> 
     <!--进度条--> 
     ...
     <form class="am-form am-form-horizontal" action="/mibaos" method="post"> 
      <div class="center div1" style="display:;"> 
       ...
       {{csrf_field()}}
       <input type="submit" value="获取邮箱号验证" class="am-btn am-btn-success" id="huoqu" style="display:block;float:left;width:150px">
      </div> 
