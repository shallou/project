  ...
  <div class="am-container header"> 
   ...
   <ul class="message-r"> 
    ...
    <div class="topMessage mini-cart"> 
     <div class="menu-hd">
      <a id="mc-menu-hd" href="/homecart" target="_top"><i class="am-icon-shopping-cart  am-icon-fw"></i><span>购物车</span><strong id="J_MiniCartNum" class="h">0</strong></a>
     </div> 
    </div> 
       ...
       <div class="bundle-main"> 
        <ul class="item-content clearfix"> 
         <div class="pay-phone"> 
          <li class="td td-item"> 
           <div class="item-pic"> 
            <a href="#" class="J_MakePoint"> <img src="{{$row['pic']}}" class="itempic J_ItemImg" width="100px" height="100px" /></a> 
           </div> 
           <div class="item-info"> 
       ...
       <!-- 选择地址开始 -->
        <div class="box"> 
         ...
         <div id="holyshit268" class="pay-address"> 
          <p class="buy-footer-address"> 寄送至：<span class="buy-line-title buy-line-title-type" id="address">{{$addressfirst->huo}}</span>  </p> 
          <p class="buy-footer-address"> <span class="buy-line-title">收货人：</span> <span class="buy-address-detail"> <span class="buy-user" id="user">{{$addressfirst->name}} </span> <span class="buy-phone" id="phone">{{$addressfirst->phone}}</span> </span> </p> 
         </div> 
        </div>
        <!-- 选择地址结束 -->
   ...
   <div class="am-u-md-12"> 
    <form class="am-form am-form-horizontal" action="/addressinsert" method="post"> 
     ...
     <div class="am-form-group"> 
      ...
      <div class="am-form-content"> 
       <textarea class="" rows="3" id="user-intro" placeholder="输入详细地址" name="huo"></textarea> 
     ...
     <div class="am-form-group theme-poptit"> 
      <div class="am-u-sm-9 am-u-sm-push-3"> 
       <div class="am-btn am-btn-danger">
        <input type="hidden" name="shuo" value="">
        {{csrf_field()}}
