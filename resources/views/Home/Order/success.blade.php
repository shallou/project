...
<html xmlns="http://www.w3.org/1999/xhtml">
 <head> 
  ...
  <title>付款成功页面</title> 
  <link rel="stylesheet" type="text/css" href="/static/Homes/xiangmv/AmazeUI-2.4.2/assets/css/amazeui.css" /> 
  ...
  <link href="/static/Homes/xiangmv/css/sustyle.css" rel="stylesheet" type="text/css" /> 
   ...
   <ul class="message-r"> 
    ...
    <div class="topMessage my-shangcheng">
     <div class="menu-hd MyShangcheng">
      <a href="/personals" target="_top"><i class="am-icon-user am-icon-fw"></i>个人中心</a>
     </div>
    </div> 
